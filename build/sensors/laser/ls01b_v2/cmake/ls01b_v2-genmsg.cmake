...
get_filename_component(_filename "/home/pi/arebot_ws/src/sensors/laser/ls01b_v2/srv/resolution.srv" NAME_WE)
add_custom_target(_ls01b_v2_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ls01b_v2" "/home/pi/arebot_ws/src/sensors/laser/ls01b_v2/srv/resolution.srv" "std_msgs/Float64"
)
...
_generate_srv_cpp(ls01b_v2
  "/home/pi/arebot_ws/src/sensors/laser/ls01b_v2/srv/resolution.srv"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ls01b_v2)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ls01b_v2\")")
  # install generated code
  install(
