...
echo_and_run cd "/home/pi/arebot_ws/src/robot/arebot_robot/arebot_calib"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/pi/arebot_ws/src/robot/arebot_robot/arebot_calib/setup.py" \
     \
    build --build-base "/home/pi/arebot_ws/build/robot/arebot_robot/arebot_calib" \
    install \
    --root="${DESTDIR-/}" \
