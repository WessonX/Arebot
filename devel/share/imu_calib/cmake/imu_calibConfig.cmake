...
if("TRUE" STREQUAL "TRUE")
  set(imu_calib_SOURCE_PREFIX /home/pi/arebot_ws/src/robot/arebot_correction/imu/imu_calib)
  set(imu_calib_DEVEL_PREFIX /home/pi/arebot_ws/devel)
  ...
  set(imu_calib_INSTALL_PREFIX /home/pi/arebot_ws/install)
...
if(NOT "/home/pi/arebot_ws/src/robot/arebot_correction/imu/imu_calib/include;/usr/include/eigen3 " STREQUAL " ")
  set(imu_calib_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/arebot_ws/src/robot/arebot_correction/imu/imu_calib/include;/usr/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'imu_calib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/arebot_ws/src/robot/arebot_correction/imu/imu_calib/${idir}'.  ${_report}")
    endif()
    _list_append_unique(imu_calib_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "accel_calib;yaml-cpp")
