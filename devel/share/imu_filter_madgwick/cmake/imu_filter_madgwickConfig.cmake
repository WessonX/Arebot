...
if("TRUE" STREQUAL "TRUE")
  set(imu_filter_madgwick_SOURCE_PREFIX /home/pi/arebot_ws/src/sensors/imu/imu_filter_madgwick)
...
if(NOT "/home/pi/arebot_ws/devel/include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'imu_filter_madgwick' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/arebot_ws/src/sensors/imu/imu_filter_madgwick/${idir}'.  ${_report}")
    endif()
