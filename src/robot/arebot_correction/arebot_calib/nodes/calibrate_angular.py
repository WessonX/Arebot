...
from arebot_calib.cfg import CalibrateAngularConfig
import tf
from math import radians, copysign
from arebot_calib.transform_utils import quat_to_angle, normalize_angle
...
class CalibrateAngular():
    def __init__(self):
        ...
        self.cmd_vel = rospy.Publisher('/calibed_cmd_vel', Twist, queue_size=5)
