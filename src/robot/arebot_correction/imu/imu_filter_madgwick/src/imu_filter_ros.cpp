  ...
  initialized_(false)
{
  ...
  if (!nh_.getParam ("/angular_scale", angular_scale_))
    angular_scale_ = 1.0;
  ...
  angular_scale_set_subscriber_ = nh_.subscribe<std_msgs::Float64>("set_angular_scale", 10, 
    boost::bind(&ImuFilterRos::angularScaleSetCallback, this, _1));
...
void ImuFilterRos::angularScaleSetCallback(const std_msgs::Float64::ConstPtr& new_scale) {
  angular_scale_ = new_scale->data;
}