...
int main(int argc, char *argv[]) {
	...
	if (!finite(radius_multiplier)) {
		ROS_ERROR("the wheel's radius multiplier is not finit, set 1");
		radius_multiplier = 1;
	}

	// 传递临时参数
	n.setParam("mobile_base_controller/temp_multiplier", radius_multiplier);
